...
(function (root, factory) {
  ...
  QRCodeModel.prototype = {
    addData: function (data) {
      var newData = new QR8bitByte(data, this.useUtf8Bom);
  ...
  var useSVG = document && document.documentElement.tagName.toLowerCase() === "svg";
